...
trait IntList {
  ...
  /**
    ...
    * @example  @example op(op(op(op(initial,x1),x2),x3),x4) where the xs are the elements of the list
    */
  ...
  /** ------------------------------------------
    ...
    * ------------------------------------------ */
  /**
    * Returns a list that contains all elememts in the opposite direction.
    *
